...
void pce_sm2encrypt_encode(uint8_t *input, uint32_t inlen, uint8_t *output, uint32_t *outlen);

int pce_sm2decrypt_decode(uint8_t *input, uint32_t inlen, uint8_t *output, uint32_t *outlen);

void pce_ecsign_encode(int curve_type, uint8_t *input, uint8_t *sig, uint32_t *sig_len);
