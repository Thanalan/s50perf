...
typedef struct {
    ...
    uint8_t mode;/*no mode */
    uint8_t dma_mode:4;/* no dma_mode*/
	uint8_t type;/*0 hash 1 sym 2 aead 3 asym */
...
typedef struct {
    ...
    uint8_t dma_mode:4;/* [7:1]:Reserved  [0]: 1 link list enable*/    
    uint8_t type:4; /*0 hash 1 sym 2 aead 3 asym */
...
typedef struct {
    ...
    uint8_t dma_mode:4;/* [7:2]:Reserved [1]: 1 dst link list enable  [0]: 1 src link list enable*/
    uint8_t type:4; /*0 hash 1 sym 2 aead 3 asym*/
    uint64_t key_iv;/* Storage Physical Address*/
    uint64_t in;/* Input data, the first address of the physical address*/
    uint64_t out;/* Output data, the first address of the physical address */
...
typedef struct {
	...
	pce_rand_op_t rand;
	    ...
	    uint8_t mode;
            uint8_t dma_mode:4;
            uint8_t op_type:4; /*0 hash 1 sym 2 aead 3 asym */
        };
    };
